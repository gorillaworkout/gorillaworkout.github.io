...
var Carousel = function (_Component) {
    ...
    _createClass(Carousel, [{
        ...
        value: function renderItems(isClone) {
            ...
            var cloneItems = this.props.cloneItems;
            ...
            return _react.Children.map(this.props.children, function (item, index) {
                ...
                var slideProps = {
                    ...
                    className: _cssClasses2.default.ITEM(true, selected),
                ...
                var shouldRender = selected || index === selectedItem + 1;

                return _react2.default.createElement(
                    'li',
                    slideProps,
                    cloneItems ? (0, _react.cloneElement)(item, _extends({}, item.props, { shouldRender: shouldRender, index: index, selected: selected })) : item
                );
            });
        }
    }, {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'button',
                        { type: 'button', className: _cssClasses2.default.ARROW_PREV(!hasPrev), onClick: this.onClickPrev },
                        this.props.prevIcon
                    ),
                    _react2.default.createElement(
                        'button',
                        { type: 'button', className: _cssClasses2.default.ARROW_NEXT(!hasNext), onClick: this.onClickNext },
                        this.props.nextIcon
                    ),
                    this.renderControls(),
                    this.renderStatus()
